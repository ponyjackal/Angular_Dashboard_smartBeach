...
@Component({
    selector: 'app-beach-product-cmp',
    templateUrl: 'beach-product.html',
    styleUrls: ["./beach-product.scss"]
})

export class BeachesProductsComponent implements OnInit {

@Input() set data(val:any) {
    this.beach = val;
    this.getBeachGrid(this.beach.beach_id);
}
public grid:any;
...
public imgPath = "http://dev-smart-beach.ga/uploads/285e8425-56a1-44a7-b77a-213a9c4a058c/elements/";
//public imgPath = null;
umbrellas: any = [];
baldaquins: any = [];
...
getBeachGrid(beach_id){
    this.beachService.getAdminBeachGrid(beach_id)
    .then((beach_grid) => {
        this.loaded = true;
