...
export class CustomersComponent implements OnInit {
    ...
    ngOnInit() {
      ...
      const dataStraightLinesChart = {
        ...
        series: [
                [   10,     16,     8,     13,     20,     15,     20,     34,     30,     28,     8,     20,    38  ],
                [   8,      6,      8,      3,      2,      5,      2,      4,      3,      8,     8,      2,     8  ]
        ]
      };
      ...
      this.startAnimationForLineChart(straightLinesChart); 
        ...
        const dataCustomersPerDayLineChart = {
        ...
        const optionsCustomersPerDayLineChart: any = {
            lineSmooth: Chartist.Interpolation.cardinal({
                tension: 0
            }),
            /* axisX: {
        ...
        const customersPerDayLineChart = new Chartist.Line('#customersPerDayLineChart', dataCustomersPerDayLineChart, 
          optionsCustomersPerDayLineChart);

        this.startAnimationForLineChart(customersPerDayLineChart);             
